...
| `imageCredentials.registry`                | Registry name to create credentials for                                                                                                                       | ``                                              |
| `imageCredentials.username`                | Registry username to create credentials for                                                                                                                   | ``                                              |
| `imageCredentials.password`                | Registry password to create credentials for                                                                                                                   | ``                                              |
